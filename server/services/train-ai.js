...
// https://github.com/axa-group/nlp.js/blob/master/examples/02-qna-classic/train-nlp.js

// const { NlpManager } = require("node-nlp");
const fs = require("fs");


// const managerial = new NlpManager({ languages: ["en"], nlu: { log: () => {} } /*, forceNER: true */});

module.exports = async function manager(manager) {
